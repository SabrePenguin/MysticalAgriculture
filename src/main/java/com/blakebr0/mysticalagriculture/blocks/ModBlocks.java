...
public class ModBlocks {
    ...
    public static BlockSoulstoneSlab blockCobbledSoulstoneSlab = new BlockSoulstoneSlab("cobbled_soulstone_slab",
            false);
    public static BlockSoulstoneSlab blockCobbledSoulstoneSlabFull = new BlockSoulstoneSlab(
            "cobbled_soulstone_slab_full", true);
    public static BlockSoulstoneSlab blockSoulstoneBrickSlab = new BlockSoulstoneSlab("soulstone_brick_slab", false);
    public static BlockSoulstoneSlab blockSoulstoneBrickSlabFull = new BlockSoulstoneSlab("soulstone_brick_slab_full",
            true);
    private static IBlockState cobbledSoulstone = blockSoulstone.getDefaultState().withProperty(BlockSoulstone.VARIANT,
            BlockSoulstone.Type.COBBLED);
    private static IBlockState brickSoulstone = blockSoulstone.getDefaultState().withProperty(BlockSoulstone.VARIANT,
            BlockSoulstone.Type.BRICK);
    public static BlockSoulstoneStairs blockCobbledSoulstoneStairs = new BlockSoulstoneStairs(
            "cobbled_soulstone_stairs", cobbledSoulstone);
    public static BlockSoulstoneStairs blockSoulstoneBrickStairs = new BlockSoulstoneStairs("soulstone_brick_stairs",
            brickSoulstone);
    public static BlockSoulstoneWall blockCobbledSoulstoneWall = new BlockSoulstoneWall("cobbled_soulstone_wall",
            cobbledSoulstone.getBlock());
    public static BlockSoulstoneWall blockSoulstoneBrickWall = new BlockSoulstoneWall("soulstone_brick_wall",
            brickSoulstone.getBlock());
    ...
    public static BlockInferiumFurnace blockInferiumFurnaceActive = new BlockInferiumFurnace(true,
            "inferium_furnace_active");
    public static BlockPrudentiumFurnace blockPrudentiumFurnace = new BlockPrudentiumFurnace(false,
            "prudentium_furnace");
    public static BlockPrudentiumFurnace blockPrudentiumFurnaceActive = new BlockPrudentiumFurnace(true,
            "prudentium_furnace_active");
    public static BlockIntermediumFurnace blockIntermediumFurnace = new BlockIntermediumFurnace(false,
            "intermedium_furnace");
    public static BlockIntermediumFurnace blockIntermediumFurnaceActive = new BlockIntermediumFurnace(true,
            "intermedium_furnace_active");
    public static BlockSuperiumFurnace blockSuperiumFurnace = new BlockSuperiumFurnace(false, "superium_furnace");
    public static BlockSuperiumFurnace blockSuperiumFurnaceActive = new BlockSuperiumFurnace(true,
            "superium_furnace_active");
    public static BlockSupremiumFurnace blockSupremiumFurnace = new BlockSupremiumFurnace(false, "supremium_furnace");
    public static BlockSupremiumFurnace blockSupremiumFurnaceActive = new BlockSupremiumFurnace(true,
            "supremium_furnace_active");
    public static BlockUltimateFurnace blockUltimateFurnace = new BlockUltimateFurnace(false, "ultimate_furnace");
    public static BlockUltimateFurnace blockUltimateFurnaceActive = new BlockUltimateFurnace(true,
    ...
    public static void init() {
        ...
        registry.register(blockStorage, "storage", new ItemBlockStorage(blockStorage),
                Ore.of(0, "blockInferiumEssence"), Ore.of(1, "blockPrudentiumEssence"),
                Ore.of(2, "blockIntermediumEssence"),
        ...
        registry.register(blockIngotStorage, "ingot_storage", new ItemBlockIngotStorage(blockIngotStorage),
                Ore.of(0, "blockBaseEssence"), Ore.of(1, "blockInferium"), Ore.of(2, "blockPrudentium"),
                Ore.of(3, "blockIntermedium"),
        ...
        registry.register(new ItemSlab(blockSoulstoneSlab, blockSoulstoneSlab, blockSoulstoneSlabFull),
                "soulstone_slab");
        ...
        registry.register(
                new ItemSlab(blockCobbledSoulstoneSlab, blockCobbledSoulstoneSlab, blockCobbledSoulstoneSlabFull),
                "cobbled_soulstone_slab");
        ...
        registry.register(new ItemSlab(blockSoulstoneBrickSlab, blockSoulstoneBrickSlab, blockSoulstoneBrickSlabFull),
                "soulstone_brick_slab");
