    ...
    public static void setState(boolean active, World world, BlockPos pos) {
        ...
        if (active) {
            world.setBlockState(pos,
                    ModBlocks.blockSuperiumFurnaceActive.getDefaultState().withProperty(FACING, state.getValue(FACING)),
                    3);
            world.setBlockState(pos,
                    ModBlocks.blockSuperiumFurnaceActive.getDefaultState().withProperty(FACING, state.getValue(FACING)),
                    3);
            ...
            world.setBlockState(pos,
                    ModBlocks.blockSuperiumFurnace.getDefaultState().withProperty(FACING, state.getValue(FACING)), 3);
            world.setBlockState(pos,
                    ModBlocks.blockSuperiumFurnace.getDefaultState().withProperty(FACING, state.getValue(FACING)), 3);
        }
