...
public class ItemWateringCan extends ItemMeta implements IEnableable {
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World world, BlockPos pos, EnumHand hand, EnumFacing facing,
        ...
        if (this.water) {
            ...
            Iterable<BlockPos> blocks = BlockPos.getAllInBox(pos.add(-range, -range, -range),
            ...
            if (!world.isRemote) {
                ...
                if (chance <= (40 + bonus)) {
                    for (BlockPos aoePos : blocks) {
                        ...
                        if (plant instanceof IGrowable || plant instanceof IPlantable || plant == Blocks.MYCELIUM ||
                                plant == Blocks.CHORUS_FLOWER) {
