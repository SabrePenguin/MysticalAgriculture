...
public class ItemPrudentiumArmor extends ItemArmor implements IRepairMaterial {
    ...
    public void addInformation(ItemStack stack, @Nullable World world, List<String> tooltip, ITooltipFlag advanced) {
        ...
        if (ModConfig.confSetBonuses) {
            tooltip.add(Tooltips.SET_BONUS + Colors.GREEN + Tooltips.WATER_BREATHING);
        }
    }
    ...
    public static boolean isFullSet(EntityPlayer player) {
        ...
        return !head.isEmpty() && head.getItem() instanceof ItemPrudentiumArmor && !chest.isEmpty() &&
                chest.getItem() instanceof ItemPrudentiumArmor && !legs.isEmpty() &&
                legs.getItem() instanceof ItemPrudentiumArmor && !feet.isEmpty() &&
                feet.getItem() instanceof ItemPrudentiumArmor;
    }
}
