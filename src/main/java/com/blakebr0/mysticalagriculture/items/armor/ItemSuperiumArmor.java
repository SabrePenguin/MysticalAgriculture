...
public class ItemSuperiumArmor extends ItemArmor implements IRepairMaterial {
    ...
    public void addInformation(ItemStack stack, @Nullable World world, List<String> tooltip, ITooltipFlag advanced) {
        ...
        if (ModConfig.confSetBonuses) {
            tooltip.add(Tooltips.SET_BONUS + Colors.AQUA + Tooltips.NO_FALL_DAMAGE);
        }
    }
    ...
    public static boolean isFullSet(EntityPlayer player) {
        ...
        return !head.isEmpty() && head.getItem() instanceof ItemSuperiumArmor && !chest.isEmpty() &&
                chest.getItem() instanceof ItemSuperiumArmor && !legs.isEmpty() &&
                legs.getItem() instanceof ItemSuperiumArmor && !feet.isEmpty() &&
                feet.getItem() instanceof ItemSuperiumArmor;
    }
