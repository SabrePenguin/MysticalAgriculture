...
public class ItemCharm extends ItemMeta {
    ...
    public void init() {
        ...
        itemCharmAbsorption = addItem(2, "absorption", Applicable.HELMET, Applicable.CHESTPLATE, Applicable.LEGGINGS,
                Applicable.BOOTS);
        itemCharmWither = addItem(3, "wither", Applicable.HELMET, Applicable.CHESTPLATE, Applicable.LEGGINGS,
                Applicable.BOOTS);
        itemCharmAntivenom = addItem(4, "antivenom", Applicable.HELMET, Applicable.CHESTPLATE, Applicable.LEGGINGS,
                Applicable.BOOTS);
        itemCharmFire = addItem(5, "fire", Applicable.HELMET, Applicable.CHESTPLATE, Applicable.LEGGINGS,
                Applicable.BOOTS);
        itemCharmResistance = addItem(6, "resistance", Applicable.HELMET, Applicable.CHESTPLATE, Applicable.LEGGINGS,
                Applicable.BOOTS);
