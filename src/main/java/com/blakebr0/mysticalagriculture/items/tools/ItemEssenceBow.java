...
public class ItemEssenceBow extends ItemBow implements IRepairMaterial, ICustomBow {
        ...
        this.addPropertyOverride(new ResourceLocation("pull"), new IItemPropertyGetter() {
            ...
            public float apply(ItemStack stack, @Nullable World world, @Nullable EntityLivingBase entity) {
                if (entity == null) {
                    ...
                    return !itemstack.isEmpty() && itemstack.getItem() instanceof ItemEssenceBow ?
                            (float) (stack.getMaxItemUseDuration() - entity.getItemInUseCount()) *
                                    getDrawSpeedMulti(stack) / 20.0F :
                            0.0F;
                }
            }
        });
    ...
    public void onPlayerStoppedUsing(ItemStack stack, World world, EntityLivingBase entityLiving, int timeLeft) {
        if (entityLiving instanceof EntityPlayer) {
            ...
            i = net.minecraftforge.event.ForgeEventFactory.onArrowLoose(stack, world, (EntityPlayer) entityLiving, i,
