...
public class ItemSupremiumHoe extends ItemEssenceHoe {
    ...
    public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, ITooltipFlag advanced) {
        ...
        tooltip.add(Tooltips.HOE_TOOLTIP[0] + " " + Colors.GRAY +
                Minecraft.getMinecraft().gameSettings.keyBindSneak.getDisplayName() + " " + Tooltips.HOE_TOOLTIP[1] +
                " " + Colors.RED + range + "x" + range + Colors.GRAY + ".");
