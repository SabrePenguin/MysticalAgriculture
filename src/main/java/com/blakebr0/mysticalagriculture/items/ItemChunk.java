...
public class ItemChunk extends ItemMeta {
    ...
    public void init() {
        ...
        itemExperienceChunk = addItem(5, "experience_chunk", true,
                Utils.asList(Tooltips.DROP_CHANCE + Colors.RED + "10%"));
        ...
        itemChickenChunk = addItem(8, "chicken_chunk", type.CHICKEN.isEnabled(),
                getChunkTooltip(type.CHICKEN.getTier()));
        ...
        itemSkeletonChunk = addItem(12, "skeleton_chunk", type.SKELETON.isEnabled(),
                getChunkTooltip(type.SKELETON.getTier()));
        itemCreeperChunk = addItem(13, "creeper_chunk", type.CREEPER.isEnabled(),
                getChunkTooltip(type.CREEPER.getTier()));
        ...
        itemGuardianChunk = addItem(16, "guardian_chunk", type.GUARDIAN.isEnabled(),
                getChunkTooltip(type.GUARDIAN.getTier()));
        ...
        itemEndermanChunk = addItem(19, "enderman_chunk", type.ENDERMAN.isEnabled(),
                getChunkTooltip(type.ENDERMAN.getTier()));
        itemWitherSkeletonChunk = addItem(20, "wither_skeleton_chunk", type.WITHER_SKELETON.isEnabled(),
                getChunkTooltip(type.WITHER_SKELETON.getTier()));
