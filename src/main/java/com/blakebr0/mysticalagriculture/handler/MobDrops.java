...
public class MobDrops {
    ...
    public void onMobDrops(LivingDropsEvent event) {
        ...
        if (event.getEntity() instanceof EntityWither) {
            drop(attacked, ModItems.itemCrafting, ModConfig.confWitherSupremium, 4, ModConfig.confWitherSupremium,
                    drops);
        }

        if (event.getEntity() instanceof EntityDragon) {
            drop(attacked, ModItems.itemCrafting, ModConfig.confDragonSupremium, 4, ModConfig.confDragonSupremium,
                    drops);
        }
    }
