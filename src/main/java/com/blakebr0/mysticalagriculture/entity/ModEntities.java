...
public class ModEntities {
    ...
    public static void init() {
        EntityRegistry.registerModEntity(new ResourceLocation(MysticalAgriculture.MOD_ID, "inferium_arrow"),
                EntityInferiumArrow.class, "inferium_arrow", 0, MysticalAgriculture.INSTANCE, 64, 1, true);
        EntityRegistry.registerModEntity(new ResourceLocation(MysticalAgriculture.MOD_ID, "prudentium_arrow"),
                EntityPrudentiumArrow.class, "prudentium_arrow", 1, MysticalAgriculture.INSTANCE, 64, 1, true);
        EntityRegistry.registerModEntity(new ResourceLocation(MysticalAgriculture.MOD_ID, "intermedium_arrow"),
                EntityIntermediumArrow.class, "intermedium_arrow", 2, MysticalAgriculture.INSTANCE, 64, 1, true);
        EntityRegistry.registerModEntity(new ResourceLocation(MysticalAgriculture.MOD_ID, "superium_arrow"),
                EntitySuperiumArrow.class, "superium_arrow", 3, MysticalAgriculture.INSTANCE, 64, 1, true);
        EntityRegistry.registerModEntity(new ResourceLocation(MysticalAgriculture.MOD_ID, "supremium_arrow"),
                EntitySupremiumArrow.class, "supremium_arrow", 4, MysticalAgriculture.INSTANCE, 64, 1, true);
    }
