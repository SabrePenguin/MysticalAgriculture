...
@Mod(modid = MysticalAgriculture.MOD_ID,
     name = MysticalAgriculture.NAME,
     version = Tags.VERSION,
     dependencies = MysticalAgriculture.DEPENDENCIES,
     guiFactory = MysticalAgriculture.GUI_FACTORY)
