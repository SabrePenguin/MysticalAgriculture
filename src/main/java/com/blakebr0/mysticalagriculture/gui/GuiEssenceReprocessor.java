...
public class GuiEssenceReprocessor extends GuiContainer {
    ...
    private static final ResourceLocation GUI = ResourceHelper.getResource(MysticalAgriculture.MOD_ID,
            "textures/gui/essence_reprocessor_gui.png");
    ...
    protected void renderHoveredToolTip(int mouseX, int mouseY) {
        ...
        if (mouseX > this.guiLeft + 19 && mouseX < this.guiLeft + 29 && mouseY > this.guiTop + 17 &&
                mouseY < this.guiTop + 84) {
            this.drawHoveringText(
                    Utils.format(this.machine.getFuel()) + " / " + Utils.format(this.machine.getFuelCapacity()), mouseX,
                    mouseY);
        }

        if (this.machine.getFuelLeft() > 0) {
            if (mouseX > this.guiLeft + 36 && mouseX < this.guiLeft + 50 && mouseY > this.guiTop + 33 &&
                    mouseY < this.guiTop + 47) {
