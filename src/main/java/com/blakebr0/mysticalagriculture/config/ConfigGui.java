...
public class ConfigGui extends GuiConfig {
    ...
    public ConfigGui(GuiScreen parent) {
        super(parent, getConfigElements(), "mysticalagriculture", false, false,
    ...
    private static List<IConfigElement> getConfigElements() {
        ...
        list.add(new DummyConfigElement.DummyCategoryElement("essence recipes", "essence recipes",
                essenceRecipeCategories) {
